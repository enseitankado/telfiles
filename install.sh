...
cat <<EOF
${C_Y}${C_BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C_RST}
${C_Y}${C_BOLD}  ⚠  Bir adım daha kaldı — Telegram API kimlikleri eksik${C_RST}
${C_Y}${C_BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C_RST}
  ...
  ${C_BOLD}1) Kimlikleri alın${C_RST}
       ...
       gibi bırakabilirsiniz). Karşınıza şunlar gelir:
         App api_id    →  TELEGRAM_API_ID  (sadece rakam)
         App api_hash  →  TELEGRAM_API_HASH (32 karakter hex)

  ${C_BOLD}2) .env dosyasına yazın${C_RST}
       cd $(pwd)
       nano .env          ${C_DIM}# (veya tercih ettiğiniz editör)${C_RST}

     Açılan dosyada şu iki satırı doldurun:
         TELEGRAM_API_ID=12345678
         TELEGRAM_API_HASH=0123456789abcdef0123456789abcdef

  ${C_BOLD}3) Uygulamayı yeniden başlatın${C_RST}
       $DOCKER_CMD compose restart telfiles-app

  Tamamlandığında arayüzde ${C_BOLD}Ayarlar → Hesap → ➕ Hesap Ekle${C_RST}
  adımıyla Telegram hesabınızı bağlayabilir, taramayı başlatabilirsiniz.
